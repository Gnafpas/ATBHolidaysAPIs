...
/**
 * <p>Java class for JP_CheckAvailAdvancedOptions complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="JP_CheckAvailAdvancedOptions">
 *   &lt;complexContent>
...
@XmlType(name = "JP_CheckAvailAdvancedOptions", propOrder = {
    "useCurrency",
    "showBreakdownPrice"
})
@XmlSeeAlso({
    JPHotelCheckAvailAdvancedOptions.class,
    JPInsuranceCheckAvailAdvancedOptions.class,
    JPServicesCheckAvailAdvancedOptions.class,
    JPPackageCheckAvailAdvancedOptions.class,
    JPRentacarCheckAvailAdvancedOptions.class,
    JPCruiseCheckAvailAdvancedOptions.class,
    JPFlightCheckAvailAdvancedOptions.class
})
public abstract class JPCheckAvailAdvancedOptions
