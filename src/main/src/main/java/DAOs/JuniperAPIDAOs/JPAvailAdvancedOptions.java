...
/**
 * <p>Java class for JP_AvailAdvancedOptions complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="JP_AvailAdvancedOptions">
 *   &lt;complexContent>
...
@XmlType(name = "JP_AvailAdvancedOptions", propOrder = {
    "useCurrency",
    "showBreakdownPrice"
})
@XmlSeeAlso({
    JPRentacarAvailAdvancedOptions.class,
    JPFlightAvailAdvancedOptions.class,
    JPHotelAvailAdvancedOptions.class,
    JPInsuranceAvailAdvancedOptions.class,
    JPCruiseAvailAdvancedOptions.class,
    JPPackageAvailAdvancedOptions.class,
    JPServicesAvailAdvancedOptions.class
})
public abstract class JPAvailAdvancedOptions
