...
public class ViatorProductInclusionsDAO {
    ...
    public static boolean addproductinclusions(ViatorProductInclusionsBean productinclusionsBean,StatelessSession session){

        boolean err=false;
        try{
            session.insert(productinclusionsBean);
