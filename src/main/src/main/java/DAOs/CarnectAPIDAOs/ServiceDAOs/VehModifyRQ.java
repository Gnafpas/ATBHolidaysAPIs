...
@XmlRootElement(name = "VehModifyRQ")
public class VehModifyRQ {
    ...
    protected List<VehModifyRQ.VehModifyRQCore> vehModifyRQCore;
    @XmlElement(name = "VehModifyRQInfo")
    protected List<VehModifyRQ.VehModifyRQInfo> vehModifyRQInfo;
     ...
     * {@link VehModifyRQ.VehModifyRQCore }
     * 
     * 
     */
    public List<VehModifyRQ.VehModifyRQCore> getVehModifyRQCore() {
        if (vehModifyRQCore == null) {
            vehModifyRQCore = new ArrayList<VehModifyRQ.VehModifyRQCore>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link VehModifyRQ.VehModifyRQInfo }
     * 
     * 
     */
    public List<VehModifyRQ.VehModifyRQInfo> getVehModifyRQInfo() {
        if (vehModifyRQInfo == null) {
            vehModifyRQInfo = new ArrayList<VehModifyRQ.VehModifyRQInfo>();
        }
