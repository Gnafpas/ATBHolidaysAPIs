...
public class ArrayOfVehicleReservationRQAdditionalInfoTypeCoveragePref {
    ...
    protected List<ArrayOfVehicleReservationRQAdditionalInfoTypeCoveragePref.CoveragePref> coveragePref;
     ...
     * {@link ArrayOfVehicleReservationRQAdditionalInfoTypeCoveragePref.CoveragePref }
     * 
     * 
     */
    public List<ArrayOfVehicleReservationRQAdditionalInfoTypeCoveragePref.CoveragePref> getCoveragePref() {
        if (coveragePref == null) {
            coveragePref = new ArrayList<ArrayOfVehicleReservationRQAdditionalInfoTypeCoveragePref.CoveragePref>();
        }
