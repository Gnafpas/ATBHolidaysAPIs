...
public class ArrayOfOTAVehRateRuleRQRentalInfoSpecialEquipPref {
    ...
    protected List<ArrayOfOTAVehRateRuleRQRentalInfoSpecialEquipPref.SpecialEquipPref> specialEquipPref;
     ...
     * {@link ArrayOfOTAVehRateRuleRQRentalInfoSpecialEquipPref.SpecialEquipPref }
     * 
     * 
     */
    public List<ArrayOfOTAVehRateRuleRQRentalInfoSpecialEquipPref.SpecialEquipPref> getSpecialEquipPref() {
        if (specialEquipPref == null) {
            specialEquipPref = new ArrayList<ArrayOfOTAVehRateRuleRQRentalInfoSpecialEquipPref.SpecialEquipPref>();
        }
