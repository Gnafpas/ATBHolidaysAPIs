 ...
 */
@Entity
@Table(name = "viator_update_destinations_info", schema = "develope_viator", catalog = "")
public class ViatorUpdateDestinationsInfoBean {
    private int rid;
    ...
    public boolean equals(Object o) {
        ...
        ViatorUpdateDestinationsInfoBean that = (ViatorUpdateDestinationsInfoBean) o;
