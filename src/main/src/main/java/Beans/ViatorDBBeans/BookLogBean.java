 ...
 */
@Entity
@Table(name = "book_log", schema = "develope_viator", catalog = "")
public class BookLogBean {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        BookLogBean that = (BookLogBean) o;

        if (id != that.id) return false;
        if (client != null ? !client.equals(that.client) : that.client != null) return false;
        if (clientBookingId != null ? !clientBookingId.equals(that.clientBookingId) : that.clientBookingId != null)
            return false;
        ...
        if (providerBookingId != null ? !providerBookingId.equals(that.providerBookingId) : that.providerBookingId != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (clientBookingId != null ? clientBookingId.hashCode() : 0);
        ...
        result = 31 * result + (providerBookingId != null ? providerBookingId.hashCode() : 0);
