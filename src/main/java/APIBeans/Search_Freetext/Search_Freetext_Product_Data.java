 ...
 */
public class Search_Freetext_Product_Data {
    ...
    private String onRequestPeriod;//todo Put correct type of atribute/
    private int primaryGroupId;//todo Put correct type of atribute/
