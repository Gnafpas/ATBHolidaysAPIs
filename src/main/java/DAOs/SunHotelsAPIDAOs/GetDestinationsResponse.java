 ...
 *       &lt;sequence>
 *         &lt;element name="GetDestinationsResult" type="{http://xml.sunhotels.net/15/}DestinationList" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetDestinationsResponse {
    ...
    protected DestinationList getDestinationsResult;
     ...
     *     
     */
    public DestinationList getGetDestinationsResult() {
     ...
     *     
     */
    public void setGetDestinationsResult(DestinationList value) {
